...
* [#22](https://github.com/Tim55667757/PriceGenerator/issues/22) Тип данных `ZigZagFilter()` фильтра изменён на Pandas Dataframe вместо dict.
* [#25](https://github.com/Tim55667757/PriceGenerator/issues/25) Значение объёма свечи теперь больше зависит и связано с предыдущими значениями и вероятностью выбросов.

##### Баг-фиксы

* [#24](https://github.com/Tim55667757/PriceGenerator/issues/24) Исправлена ошибка с появлением отрицательных чисел при генерации длинных цепочек свечей.
